...
# ---------------------------------------------------------------------
set TOP_LEVEL_MODULE     tb_split_mlp_shared_bram

# ---------------------------------------------------------------------
# Define the simulation flow
# ---------------------------------------------------------------------
# Only flow option for this design is STANDALONE
set FLOW                 "STANDALONE"
...
# Inside the MLP are some unique case statements that issue warnings at time 0
# Disable this warning with code 8315
quietly set NOWARN_OPTIONS        "+nowarnTFMPC +nowarn8315"
