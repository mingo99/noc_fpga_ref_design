...
# -------------------------------------------------------------------------
# Set main clocks to 500MHz.  Note that i_send_clk is fractionally below 500MHz.
...
# Set cryptocore clock to 200MHz
create_clock -name cc_clk   [get_ports i_cc_clk]   -period 5.0
